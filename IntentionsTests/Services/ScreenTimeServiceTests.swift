...
final class ScreenTimeServiceTests: XCTestCase, @unchecked Sendable {
    ...
    func testBlockAllAppsClearsAllowedApps() async throws {
        ...
        try await mockService.allowApps(tokens, categories: [], duration: 3600)
    ...
    func testAllowAppsRequiresAuthorization() async {
        ...
        do {
            let tokens = try createTestTokens()
            try await mockService.allowApps(tokens, categories: [], duration: 1800)
    ...
    func testAllowAppsRejectsInvalidDuration() async throws {
        ...
        do {
            try await mockService.allowApps(tokens, categories: [], duration: -1)
        ...
        do {
            try await mockService.allowApps(tokens, categories: [], duration: 0)
    ...
    func testAllowAppsReplacesExistingSession() async throws {
        ...
        try await mockService.allowApps(firstTokens, categories: [], duration: 3600)
        ...
        try await mockService.allowApps(secondTokens, categories: [], duration: 1800)
    ...
    func testSessionExpiresAutomatically() async throws {
        ...
        try await mockService.allowApps(tokens, categories: [], duration: 0.1) // 100ms
    ...
    func testSessionExpirationCancellation() async throws {
        ...
        try await mockService.initialize()
        let tokens = try createTestTokens()
        try await mockService.allowApps(tokens, categories: [], duration: 10) // 10 seconds
    ...
    func testStatusInfoAccuracy() async throws {
        ...
        try await mockService.allowApps(userTokens, categories: [], duration: 3600)
    ...
    func testConcurrentAllowRequests() async throws {
        ...
        async let result1: Void = mockService.allowApps(tokens1, categories: [], duration: 1800)
        async let result2: Void = mockService.allowApps(tokens2, categories: [], duration: 3600)
    ...
    func testConcurrentBlockAndAllow() async throws {
        ...
        async let allowResult: Void = mockService.allowApps(tokens, categories: [], duration: 1800)
